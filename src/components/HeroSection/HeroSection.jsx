        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              >
                <div className="px-4 py-2 bg-gradient-to-r from-blue-500/20 to-green-500/20 rounded-full border border-blue-500/30">
                  <span className="text-blue-300 font-medium">TikTok Football Creator</span>
                </div>
            ...
            >
              <a
                href="#products"
                className="px-8 py-4 bg-gradient-to-r from-blue-500 to-green-400 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-green-500 transition-all duration-300 text-center flex items-center justify-center space-x-2"
              >
              ...
              <a
                href="#about"
                className="px-8 py-4 border-2 border-slate-600 text-white font-semibold rounded-xl hover:bg-slate-800 transition-all duration-300 text-center"
              >
                My Story
              </a>
            </motion.div>
          ...
          >
            <div className="relative">
              ...
              <div className="relative w-96 h-96 mx-auto">
                ...
                {/* Floating Stats */}
                <div className="absolute -top-4 -right-4 bg-slate-900/90 backdrop-blur-sm rounded-xl p-4 border border-slate-700/50">
                  <div className="flex items-center space-x-2">
                ...
                <div className="absolute -bottom-6 -left-6 bg-slate-900/90 backdrop-blur-sm rounded-xl p-4 border border-slate-700/50">
                  <div className="flex items-center space-x-2">
                ...
                <div className="absolute top-1/2 -right-8 bg-slate-900/90 backdrop-blur-sm rounded-xl p-4 border border-slate-700/50">
              ...
              <div className="absolute inset-0 -z-10">
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gradient-to-r from-blue-500/10 to-green-500/10 rounded-full blur-3xl" />
              </div>
            </div>
          </motion.div>
        </div>
